...
// 兵營系統
public class CampSystem : IGameSystem ,IObserver
{
	...
	public override void Initialize()
	{
        ...
        //MessageCenterByObserver.Instance.AddMessage(ListNotificaiton(),this);

	}

    public List<string> ListNotificaiton()
    {
        List<string> list = new List<string>();
        list.Add("CreatSolider");
        return list;
    }
    public void HandlerNotificaiton(string messageName, params object[] objs)
    {
        switch (messageName)
        {
            case "CreatSolider":
                UTTrainSoldier(ENUM_Soldier.Rookie);
                break;
            default:
                break;
        }
